...
function Sidebar({ setShownav, shownav }: show) {
  ...
  return (
    <>
      <nav className="contents__gnb" style={shownav ? {
        ...
        <ul>
                ...
                <a href="/">
                  <svg viewBox="0 0 24 24" focusable="false">
                    <g className="style-scope yt-icon">
                      ...
                      <polygon fill="#FFFFFF" points="15,11 10,8.35 10,13.65 "
          ...
          <ul className="footer">
            ...
            <li>
              ...
              <p>
                크리에이터들이 유튜브 상에 게시, 태그 또는 추천한 상품들은 판매자들의 약관에 따라 판매됩니다.
